...
Proof.
  intros P c Q Hhoare. induction Hhoare.
  - apply hoare_skip.
  - apply hoare_asgn.
  - apply hoare_seq with (Q := Q). assumption. assumption.
...
Lemma wp_is_precondition: forall c Q,
  {{wp c Q}} c {{Q}}.
Proof.
  intros c Q. intros st st' H. unfold wp. intros Hwp.
...
Proof.
  intros c Q P' HP'Q st HP'. intros st' H.
  apply HP'Q with st. assumption. assumption.
Qed.
