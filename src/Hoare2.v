...
(*
Applying backwards reasoning, we obtain the following
annotated program with hole I.
...
Let I = Z + X = n + m. Substituting it into the above annnotated program
...
Proof.
  ...
  apply hoare_asgn.
  intros st H. destruct H. unfold assn_sub. rewrite t_update_eq.
